...
class build_nccl(rfm.CompileOnlyRegressionTest):
   ...
   def prepare_build(self):
      ...
      self.build_system.max_concurrency = 'src.build NVCC_GENCODE=\"{}\"'.format(gencode)
...
class nccl_alltoall_test(NCCLTestBase):
   ...
   def prepare_run(self):
      ...
      ncclt_test_dir = os.path.join(self.nccl_test.stagedir,
